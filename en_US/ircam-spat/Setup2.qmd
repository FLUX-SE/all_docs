...
![](https://media.githubusercontent.com/media/FLUX-SE/doc_images/main/Plugins/ircam-spat/spat_17.jpg)
...
:::{.callout-note}
Please note that if you move a speaker in the source view, the associated delay is automatically applied on the corresponding output according to the speaker distance.
:::
