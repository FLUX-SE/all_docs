# Tablet Remote (Lemur) - Legacy {#sec-lemure}
...
![image(0)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurImportPatch.png)

![image(1)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurImportPatchMenu.png)
...
![image(2)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurOSCSettings.png)

In OSC Targets, you can see the IP Address of your actual remote device. (Lemur IP: **x.x.x.x**). 
The port is locked by default at ```8000```. 
...
As of _SPAT Revolution_ 20.12, input | Lemur and output | Lemur presets are available in the OSC Connection section. Port are by default ```8000``` for input and output.

From the above example, the Lemur IP is ```192.168.2.5``` Port ```8000```. 
And we have set the OSC target OSC 0 to the SPAT computer IP Adress ```192.168.43.10``` with port number ```53700```. 
...
![image(3)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurOSCConnectionsMatrix.png)
...
![image(4)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurSnapshots.png)
...
![image(5)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurRemote.png)
...
![image(6)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurRemoteExplanation.png)
...
![image(7)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurXYPadModes.png)
  

## SPAT Multitouch

![image(9)](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/LemurMultitouch.png)
