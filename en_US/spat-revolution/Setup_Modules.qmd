...
Each module has a specific role. Input and Output modules take care of the routing with the outside world. Sources and Rooms are the heart of SPAT's object-based mixing engine. Basic summing and routing is done with Master and Sum modules. Transcoder can transform audio streams from one type to another. The complete module list is:
