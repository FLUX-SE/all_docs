...
![FLUX:: Center SPAT Revolution Remote](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteInstall.png)
...
Once installed, you can simply run the Open Stage Control application and configure it. According to your system, a Windows or macOS config file is downloaded. This config file can be simply loaded to Open Stage Control by pressing the three dots on the right side of the interface.
  ...
  ![Load Config](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteLoadConfig.png)
...
This config file will provide a default configuration with predefined OSC (```9400``` and ```9401```) and Web server (```9410```) port numbers.
  ...
  ![SPAT Revolution Remote Config](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteConfig.png)
...
![Run Server](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteRunServer.png)
![Server Info](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteServerInfo.png)
...
![No GUI](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteConfigNoGui.png)
...
![Autostart](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteAutostart.png)
...
![SPAT Revolution OSC Connection Input](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteSPATOSCConnectionIn.png)

- Add the ```output| SPAT Remote server``` preset

![SPAT Revolution OSC Connection Output](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteSPATOSCConnectionOut.png)
...
![Changing the IP address in the server](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteConfig_ChangeIP.png)
...
![Reaching the server from Ipad](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemote_RemoteClientIpad.png)
...
![Adding Page to iPad Home Screen 1 25%](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemote_IpadHome1.png)

![Adding Page to iPad Home Screen 2](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemote_IpadHome2.png)

![Adding Page to iPad Home Screen 3](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemote_IpadHome3.png)
...
![SPAT Revolution Main Page](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteMain.png)

![SPAT Revolution Main Page](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRevolutionRemoteSnapshot.png)
...
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/SPATRemoteMultipleDestinations.png)
