...
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Setup/InputInspectorQuad.png)

A four-channel stream could contain the format of a four-speaker channel-based format (QUAD, 4.0, LCRS) but could also contain different formats of interleaved four-channel Ambisonic audio (A-Format, B-Format). You can read more about A-Format and B-Format in the [Ambisonics -@scene-based] section of this user guide. The important thing to remember here is that confusing Ambisonic audio and Channel Based audio is a significant mistake, even though you might hear
