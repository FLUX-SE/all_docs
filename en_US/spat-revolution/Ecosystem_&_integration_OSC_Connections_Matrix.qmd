...
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCMain.png)
...
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCConnections.png)
...
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCTransformList.png)

Transform presets are accessible for each OSC connection and allow quick re-scaling of the values.

:::{.callout-note}
![](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCTransformPresets.png)
:::
