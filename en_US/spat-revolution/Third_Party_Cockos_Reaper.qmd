...
If you are using the Local Audio Path, it is also recommended reviewing the **[Appendix B - Troubleshooting -@sec-trouble-shooting]** of this guide.
...
As described in section **[SPAT PI : Local audio path -@sec-lap]**, when you are using the Local Audio path, the buffer size and sample rate must be matched in both _SPAT Revolution_ and Reaper. 
