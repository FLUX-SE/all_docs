...
![SPAT plug-in on S6L CKM module – Page 1 of 3](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LEncoders.png)
...
![Dual _SPAT Revolution_ integration to S6L via MADI](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LDualSpatRevolutionIntegrationS6LMadi.png)
**Dual _SPAT Revolution_ integration to S6L via MADI**


![_SPAT Revolution_ integration to S6L via the AVB port for audio and control](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LIntegrationAVB.png)
...
![SPAT Send plugin in the Plugins rack of VENUE](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LPluginRack.png)
**SPAT Send plugin in the Plugins rack of VENUE**


![SPAT Send plugin setup](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LSend.png)
...
![SPAT OSC Main preferences](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCMain.png)
...
![SPAT OSC Connections Matrix](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LOSCConnectionMatrixInput.png)

![SPAT OSC Connections Matrix](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LOSCConnectionMatrixOutput.png)
...
![SPAT Hardware IO (Audio) preferences – AVB example](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/S6LHardwareIOAVB.png)
