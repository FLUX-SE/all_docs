## Inputs Module {#sec-input-modules}
...
+ Input type : allow to select if the source of the signal is coming from the selected input or from the signal generator included in _SPAT Revolution_. The nature of the generated signal can be changed in the [Preference page -@sec-application-preference].
