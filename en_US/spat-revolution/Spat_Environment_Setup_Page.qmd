...
* [Masters -@sec-modules-master]
* [Binaural Monitors -@sec-modules-binaural]
* [Outputs -@sec-modules-output]

## Stream types and associated options

Modules blocs are characterized by their stream type. In spatial audio, audio streams can be of different natures, as seen in the [Spatialisation Technology -@sec-spat-technology] section.
