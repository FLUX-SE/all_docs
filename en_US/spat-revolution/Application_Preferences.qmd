# Application preference {#sec-application-preference}
...
This panel allows creating OSC connection between SPAT Revolution and other devices, like tablets, phones, computers and many others. More information is available on the [OSC section -@sec-spat-osc].
