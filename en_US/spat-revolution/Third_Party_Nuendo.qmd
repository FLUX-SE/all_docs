...
![Object-based in Nuendo V11](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADM.png ':size=800')
...
![System schematics - Nuendo and SPAT Revolution - Software In / Hardware Out](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMSoftInHardOut.png)
...
![System schematics - Nuendo and SPAT Revolution - Software I/O with SPAT Plugins](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMSoftIO.png)
...
![System schematics - Nuendo and SPAT Revolution - Core Audio / Audio Bridge](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMOSCAudioBridge.png)
...
![System schematics - Nuendo and SPAT Revolution - Dual Computers](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMOSCDualComputers.png)
...
![Audio Connection in Nuendo V11](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAudioConnections1.png)
...
![Nuendo OSC Renderer Setup](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoExternalOSCRendererSetup.png ':size=400')
...
![Nuendo Import ADM](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMImport.png)
...
![Nuendo ADM Authoring for Dolby Atmos 1](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAuthoringEmpty.png)
...
![Nuendo ADM Authoring for Dolby Atmos 2](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAuthoringObjects.png)

## Nuendo audio connections configured for object

![Audio Connection in Nuendo V11 with Bus and Object outputs](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAudioConnections2.png)



![Nuendo Surround VST MultiPanner in Object Mode](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoPanner.png ':size=500')
...
![Nuendo OSC Object Position Tracking](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoOSCObjectPositionTracking.png ':size=400')
...
![SPAT OSC settings for Nuendo ADM-OSC](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCConnectionsADM.png ':size=600')
...
![Modifying (edit) the transform of scaling](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCTransformPresetsADM.png ':size=300')
...
![ADM XYZ Output](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/Preference/OSCConnectionsADMOutputXYZ.png ':size=600')
...
![Setup up objects in the ADM Authoring for Dolby Atmos](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAuthoringEmpty.png ':size=800')
...
![Setup up objects in the ADM Authoring for Dolby Atmos](https://flux-shared.s3.amazonaws.com/doc_images/SpatR/ThirdParty/NuendoADMAuthoringObjects.png ':size=800')
