...
Two special index items labeled as **(R) REVERB** and **(M) OUTPUT** appear fixed at the bottom of the left panel. By clicking on these, we then enter into two more parameter editors: one relating to the _[Artificial reverberation -@artificial-reverb]_ and one relating to the room output configuration and [Listener Position -@sec-listener-position] editor.
