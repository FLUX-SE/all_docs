...
Software such as **[Loopback](https://rogueamoeba.com/loopback)** from **Rogue Amoeba** can be very useful to route audio between multiple devices/apps and can be a very good alternative to Aggregate and Multi-Output devices that you can already make inside the **Audio MIDI setup** of macOS.
