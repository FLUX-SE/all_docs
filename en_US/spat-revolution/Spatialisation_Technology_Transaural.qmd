...
An optimum listening position such as that needed for Transaural decoding, is also known as the _Sweet Spot_ (see [Listener Position -@sec-listener-position]). It is a fundamental concept to be aware of as we move into the next section: _Channel Based_ streams and panning algorithms.
