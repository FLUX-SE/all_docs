...
EVO Touch, as well as all other Flux:: plug-ins, provides two preset slots referred to as slot A and slot B,
...
EVO Touch provides two preset sections referred to as section A and section B, offering simultaneous access
