...
![](https://flux-shared.s3.amazonaws.com/doc_images/Analyzer/Nebula/Stereo.png) | ![](https://flux-shared.s3.amazonaws.com/doc_images/Analyzer/Nebula/51.png)
---------------------------------|-------------------------------------
Nebula / Spatial Spectrogram display with stereo input | Nebula / Spatial Spectrogram display with surround input

![](https://flux-shared.s3.amazonaws.com/doc_images/Analyzer/Nebula/Setup.png)
...
### Blur kernel size
![](https://flux-shared.s3.amazonaws.com/doc_images/Analyzer/Nebula/BlurKernelSize.png)
