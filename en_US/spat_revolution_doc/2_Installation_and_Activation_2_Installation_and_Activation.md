...
For new iLok users, the first step is to download and install the iLok license manager available on the home page of the iLok website. When your user account is successfully activated and the iLok license manager is correctly installed, you can start the licence manager software and log in to your iLok user account.
...
On this page you will find a Mac OS X, a Windows 64-bit. As well are provided legacy version for older operating systems. After downloading and installing, you can open the FLUX:: Center application to begin the process of installing the SPAT Revolution software.
