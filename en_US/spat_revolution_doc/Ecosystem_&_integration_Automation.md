...
Alternatively, a wireless OSC control surface such as _LEMUR_ running on an iPad could be used to control the parameters of _SPAT Revolution_ in real time whilst you stand in the middle of the sound system away from the computer. 
There is already a fully programmed _Lemur_ template for _SPAT Revolution_ (see [Third party integration" - Lemur](ThirdParty_Tablet_Remote.md))
