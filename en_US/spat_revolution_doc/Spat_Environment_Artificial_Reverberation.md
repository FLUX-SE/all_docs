...
In order to automate settings from a DAW, you need to instantiate a _SPAT Room_ plug-in which will open access to all the parameter controls (see [automation](Ecosystem_&_integration_DAW_Automation_Manual_setup.md) section). -->
